...
class HistoriesControllerTest < ActionController::TestCase
  ...
  test "should create history" do
    assert_difference('History.count') do
      post :create, history: { charge: @history.charge, feedback: @history.feedback, service: @history.service, tip: @history.tip }
    end
  ...
  test "should update history" do
    patch :update, id: @history, history: { charge: @history.charge, feedback: @history.feedback, service: @history.service, tip: @history.tip }
    assert_redirected_to history_path(assigns(:history))
  end
